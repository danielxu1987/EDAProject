...
The next step is to iterate through the generated True/False diet related variables and see which one has the best prediction chance.
...
for (v in selVars) {
  ...
  auc <- calcAUC(dTest[,v], dTest[,outcome]==pos)
  if(auc > 0.5){
