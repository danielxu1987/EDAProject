...
After comparing different countries with boxplot, it is noticeable that developed countries have less mortality than developing countries due to poor hygiene (e.g. water quality, unsafe sanitation and no access to handwashing facility). Two comparisons are drawn here between the *Uk* and *Tanzania*, as well as the *Netherlands* and *Cambodia*, which share similar population according to [Worldometers].(https://www.worldometers.info/world-population/population-by-country/)
