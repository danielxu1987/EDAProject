...
In contrast, causes such as *iron deficiency* and *vitamin A deficiency* lead to far less mortality. Probably lack of iron or vitamin A alone is not too critical to the survival of most people.
...
After comparing different countries with boxplot, it is noticeable that developed countries usually have less mortality than developing countries in causes related to poor hygiene (e.g. water quality, unsafe sanitation and no access to handwashing facility). 

Two comparisons are drawn here between the *Uk* and *Tanzania*, as well as the *Netherlands* and *Cambodia*, which share similar population to each counterpart according to [Worldometers](https://www.worldometers.info/world-population/population-by-country/)

```{r boxcompare, echo=FALSE}
# Define UI for application that draws a histogram
ui <- fluidPage(
