...
On the other hand, low bone mineral density rate and low birth weight rate (how much percent the number of death from these causes cover in total mortality) seem unexpectedly useful to our prediction. We do not see the unsafe sanitation back though. Perhaps dying from low mineral density and birth weight (requires the mothers to eat properly) indicate that the food security is not guaranteed in certain regions. Since food is a bottom line for survival, if food supply is not stable many other problems will appear that cause higher death rates.
