...
After inspecting the best performing variables a bit more, it seems `r original_vars[1]` works very well in training and calibration dataset, but not so well in the test data.
